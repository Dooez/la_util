...
int main() {
    ...
    /*auto spool = mu::span_pool<pooled_t>(1, asize);*/
    /*auto x     = std::array<mu::pl_span<pooled_t, true>, asize>{};*/
    /*for (auto& p: x) {*/
    /*    p = spool.acquire();*/
    /*}*/
    ...
    for (int i = 0; i < repeats; ++i) {
        ...
        auto threads =
            [&spool2, &random_counts, &start, &gen_rand]<std::size_t... I>(std::index_sequence<I...>) {
                return std::array{std::jthread(([index = I, &spool2, &random_counts, &start, &gen_rand] {
