...
auto test_cpy_a() {
    if constexpr (Test_Cpy_A) {
        return std::tuple_cat(test_mov_c<Def_C, Cpy_C, true, Test_Mov_C, Test_Mov_A, Mov_C, Mov_A>(),
...
auto test_cpy_c() {
    if constexpr (Test_Cpy_C) {
        return std::tuple_cat(
            ...
            test_cpy_a<Def_C, false, Test_Cpy_A, Test_Mov_C, Test_Mov_A, Cpy_A, Mov_C, Mov_A>());
    } else {
        return test_cpy_a<Def_C, Cpy_C, Test_Cpy_A, Test_Mov_C, Test_Mov_A, Cpy_A, Mov_C, Mov_A>();
    }
}
...
auto test_def_c() {
    if constexpr (Test_Def_C) {
        return std::tuple_cat(
            test_cpy_c<true, Test_Cpy_C, Test_Cpy_A, Test_Mov_C, Test_Mov_A, Cpy_C, Cpy_A, Mov_C, Mov_A>(),
            test_cpy_c<false, Test_Cpy_C, Test_Cpy_A, Test_Mov_C, Test_Mov_A, Cpy_C, Cpy_A, Mov_C, Mov_A>());
    } else {
